...
const statusSebagaiOptions = ["Siswa Baru", "Pindahan"];
    ...
    <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
      ...
      <fieldset className={fieldsetClass}>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4'>
          ...
          <div>
            <label className={labelClass}>Status Sebagai</label>
            {renderRadioGroup("status_sebagai", statusSebagaiOptions)}
            {errors.status_sebagai && (
              <p className={errorTextClass}>{errors.status_sebagai.message}</p>
            )}
          </div>
        </div>
      </fieldset>
